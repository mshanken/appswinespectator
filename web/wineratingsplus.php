...
<div id="wineratingsplus">
	<div id="intro">
		<div class="container">
			<div class="g6">
				    <img src="/img/devices-ios7-new.png" class="device"/>
			</div><!--/.g4-->
			<div class="g6">
