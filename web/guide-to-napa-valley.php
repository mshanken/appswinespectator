...
<head>
	...
	<title>Guide to Napa Valley | Wine Spectator Apps</title>
		...
		<div class="page" class="app-page">
			<div class="content">
				...
				<div class="one_third" id="price">
					...
					<span><img src="img/napavalley/price2.png"/></span>
			...
			<div class="content">
				<div class="one_quarter">
					...
					<a href="mailto:apps@winespectator.com?subject=Press: Guide to Napa Valley" class="button">Email Us</a>
				</div><!--/one_quarter-->
				<div class="one_quarter">
				...
				<div class="one_quarter">
					...
					<a href="/site-badge" class="button">Get your Badge</a>
				</div><!--/one_quarter-->
				<div class="one_quarter">
				...
				<!--
					...
					<a href="/press" class="button">View the Press Kit</a>
					</span>
			...
			<div class="content">
				...
				<div class="one_half" id="last-buy">
					...
					<p>And check out our <a href="/vintagechart">other app</a>.</p>
				</div><!--/one_half-->
			</div><!--/content-->
		</div><!--/page-->
