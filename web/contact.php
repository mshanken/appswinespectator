<?php  $title = 'Contact |'; include 'header.php'; ?>
	...
	<div class="container">
		...
		<div class="g12">
			...
			<p>If you have questions about how to use our apps, please tap the <img src="/img/info.png" title="Information Icon" alt="i"/> (information icon) in that app to view instructions. If your question isn&lsquo;t addressed there, let us know and we&lsquo;ll be happy to help.</p>
